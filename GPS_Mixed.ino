...
#include <SPI.h> //Para el protocolo de comunicacion con la SD
#include <SD.h>
...
void setup() {
  ...
  Serial.print("Initializing SD card..."); //Se estan generando problemas al iniciar la conexiona la tarjeta
...
void printVI() {
  if (newdataVI == true) {
    dataFile.print("VI,");//Imprimir periodo de la Llanta
    dataFile.print(t_stamp);
    dataFile.print(",");
